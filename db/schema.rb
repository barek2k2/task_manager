...
ActiveRecord::Schema.define(version: 20161021144906) do
  ...
  create_table "labelings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["task_id"], name: "index_labelings_on_task_id", using: :btree
  end
  ...
  create_table "task_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_id", "user_id"], name: "index_task_users_on_task_id_and_user_id", using: :btree
  end
